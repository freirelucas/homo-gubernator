...
subtitle: "Fase 2 — Capítulo 4 (Norris cap. 2–3)"
bibliography: ../../bibliografia.bib
format: html
---

::: {.callout-warning}
Capítulo em estado de gabarito (semana 10). Estrutura de seções abaixo. Para expandir até ~2.500–3.000 palavras, ative o subagent `.claude/agents/strogatz-chapter.md` (ou variante por fase).
:::
