...
2. **Análise de variedade** sobre indicadores de execução orçamentária. O formalismo de @ashby1956 pode ser instanciado quantitativamente: $H(D)$ é a entropia da distribuição de demandas; $H(R)$ é a entropia do conjunto de respostas administrativas observadas. A diferença é a "lacuna de variedade".
3. **Modelagem-como-governança** [@alvesschwaninger2025]: construir um modelo formal (cadeia de Markov ou modelo SD) cujo *propósito* não é prever, mas funcionar como **órgão regulador adicional** — ampliando $H(R)$ via o canal Conant-Ashby.
