...
::: {.callout-warning}
Capítulo em estado de gabarito (semana 5). Estrutura de seções abaixo. Para expandir até ~2.500–3.000 palavras, ative o subagent `.claude/agents/strogatz-chapter.md` (ou variante por fase).
:::
